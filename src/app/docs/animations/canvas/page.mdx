import GameOfLife from '@/showcase/animations/canvas/GameOfLife'
...
export const metadata = {
  title: 'Game of Life',
  description: 'A Game of Life animation',
}
...
<Preview className="py-0">
  <GameOfLife className="h-60 opacity-50" backgroundColor="white" cellColor="#ef4444" borderColor="grey" borderSize={0} />
</Preview>
